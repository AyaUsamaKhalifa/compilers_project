...
static const yytype_int16 yyrline[] =
{
     ...
     135,   142,   148,   158,   163,   170,   177,   183,   190,   196,
     202,   212,   219,   227,   235,   240,   245,   250,   255,   263,
     268,   275,   280,   287,   292,   297,   304,   309,   314,   319,
     324,   331,   336,   341,   348,   353,   358,   363,   370,   375,
     380,   387,   392,   397,   402,   410,   417,   422,   429,   435,
     441,   447,   455,   461,   467,   473,   481,   486,   493,   500,
     507,   512,   517,   522,   530,   535,   540,   545,   550,   557,
     562,   567,   572,   577,   582
};
#endif
        ...
        case Operator_Node:
            switch(p->oper.oper){
                ...
                case EE:
                {
                    ...
                    {
                        if(finalType == IntType)
                        {
                            fprintf(OutputQuadraplesFile, "CONV_INT\n");                      
                        }
                        else if(finalType == FloatType)
                        {
                            fprintf(OutputQuadraplesFile, "CONV_FLOAT\n"); 
                        }
                    }
                    fprintf(OutputQuadraplesFile, "COMP_E \n");
                    return BoolType;
                ...
                case '!':
                {
                    ...
                    if(typeOP == BoolType || typeOP == IntType)
                    {
                        if(typeOP == IntType)
                        {
                            fprintf(OutputQuadraplesFile, "CONV_BOOL\n"); 
                        }
                        return BoolType;
                    }
                    else
